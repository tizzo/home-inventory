...
// Type stubs for Rust types not supported by typeshare
type Decimal = number;
...
export interface LocationUpdateProposal {
	description?: string;
	tags?: string[];
}
...
export interface ItemImportDraftResponse {
	...
	status: string;
	items: ItemImportDraftItem[];
	location_updates?: LocationUpdateProposal;
	source_photo_ids: string[];
	created_at: Date;
	updated_at: Date;
}
...
export interface ShelvingUnitPosition {
	id: string;
...
export interface LinkedRoomInfo {
	id: string;
	name: string;
	shelving_unit_count: number;
}

export interface FloorPlanWithPositionsResponse {
	floor_plan: FloorPlanResponse;
	positions: PositionResponse[];
	linked_rooms: LinkedRoomInfo[];
}
